...
var paths = {
	...
	copyScripts: [],
	vendorScripts: ['node_modules/picturefill/dist/picturefill.js'],
	vendorStyles: [],
...
gulp.task('reloadPHP', function() {
	gulp.src(paths.php).pipe(browserSync.stream());
});
