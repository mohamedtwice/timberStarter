...
add_filter( 'timber_context', 'timberStarter_add_to_context' );
 ...
 * @param object $twig
 */
function timberStarter_add_to_twig( $twig ) {
	$twig->addExtension( new Twig_Extension_StringLoader() );
	$twig->addFilter( 'myfoo', new Twig_Filter_Function( 'myfoo' ) );

	return $twig;
}
// add_filter( 'get_twig', 'timberStarter_add_to_twig' );
